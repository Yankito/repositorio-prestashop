...
class appAppKernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'yanko2002291_db_1', 'port' => '', 'dbname' => 'prestashopDB', 'user' => 'usuarioprestashop', 'password' => 'password', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('UcF16ONRfx9tM3GPqkMjNuTsyzfnVz729LPqzq30is102LW7gHCtC3Im35ofufTh'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'database_host' => 'yanko2002291_db_1',
            'database_port' => '',
            'database_name' => 'prestashopDB',
            'database_user' => 'usuarioprestashop',
            ...
            'secret' => 'UcF16ONRfx9tM3GPqkMjNuTsyzfnVz729LPqzq30is102LW7gHCtC3Im35ofufTh',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-06-14',
            'locale' => 'es-ES',
            'use_debug_toolbar' => true,
            'cookie_key' => '2qfumgAZfHrKxJ8fgAYG7PKMhn9Z9ONbf4LuJSkAqBRcWtidW3iFHbcow5TXeJd1',
            'cookie_iv' => 'EvEED59rxma8fCyc0MM48GEHGhUJPGtk',
            'new_cookie_key' => 'def00000a0e28eaf54b1918d183dd489ae30cb11c0afb106d5ee70bb2711a72f3dab008c4d1a8fcb686be03660fe8a764ea80603693a05941993c6519a74ac8c06418376',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAownrf2Ljkit64c0zK9Ih'."\n".'8P4h2wDqnhxYe/Z3X0tqls7sAM2LcM4bieM6ah/olNloDm/AfNIf3iWndMB5NMZC'."\n".'SeprhbGEPxOD+tK5IoKx1keugeTGLrRu87DtNj2Gad3oD6ilx1e+pgww6YH4e4D6'."\n".'FhGmgimTQUJdZQazzwzmqaI4SkxO+bEgrb1ijOEfB6994f79Ilau7oJ0TjTRwnde'."\n".'ZtdDn5iPU5ddo5Mid8qCauFSh0L1G8DUoWZ2dKRluwceMPfwZU7GXj7kwJjXiUm6'."\n".'2Qg/rnNIKxHAmCvpoDUNaD5tFSN1DzsEnfHUUzCLlyZbqNIAPENgSoUwOBRVA04X'."\n".'PwIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            ...
            'modules_translation_paths' => [
                ...
                39 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                ...
                54 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
            ...
            'kernel.secret' => 'UcF16ONRfx9tM3GPqkMjNuTsyzfnVz729LPqzq30is102LW7gHCtC3Im35ofufTh',
